...
namespace DisabledPeopleRegister.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Username,Password,Age")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Username,Password,Age")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
